...
type Props = {
  ...
  onAddRecipients: (selected: TChatParticipant[]) => void;
};
      ...
      <Autocomplete
        ...
        renderOption={(props, recipient, { selected }) => (
          <li {...props} key={recipient.id}>
            ...
            >
              <Avatar alt={recipient.name} src={recipient.imageName} sx={{ width: 1, height: 1 }} />
              <Stack
                alignItems="center"
        ...
        renderTags={(selected, getTagProps) =>
          selected.map((recipient, index) => (
            <Chip
              ...
              avatar={<Avatar alt={recipient.name} src={recipient.imageName} />}
              variant="soft"
            />
          ))
        }
