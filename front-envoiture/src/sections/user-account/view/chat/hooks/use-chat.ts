...
import { sendMessage, createNewConversation } from 'src/redux/actions/chat-action';
// routes
...
import { addRecipients } from 'src/redux/reducer/chat-reducer';
...
export default function useChat() {
  ...
  const baseUrl = paths.user.profile(user?.id, user?.lname);
